...
ctr_data <- read.table('/work/DC_exam/Hard_to_get/in/Data/raw_data/Ahn_data/Ahn_data_heroin_filtered.txt', header = TRUE)
...
write.csv(samples_df, "posterior_samples_heroin_Ahn_1000scale.csv", row.names = FALSE)
...
png("traceplot_Ahn_heroin_1000scale.png", width = 1200, height = 800)
...
# Save the workspace 
save.image(file = "estimation_ahn_heroin_1000scale.RData")