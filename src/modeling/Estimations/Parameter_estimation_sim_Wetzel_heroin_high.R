...
ctr_data <- read.csv('/work/DC_exam/Hard_to_get/out/LLM_simulated_data/deckn_results_wetzels-addict-high_150_42_2024-12-21_20-01-32.txt', header = TRUE)
...
write.csv(samples_df, "posterior_samples_sim_Wetzel_heroin_high.csv", row.names = FALSE)
...
png("traceplot_sim_Wetzel_heroin_high.png", width = 1200, height = 800)
...
# Save the workspace 
save.image(file = "estimation_sim_Wetzel_heroin_high.RData")