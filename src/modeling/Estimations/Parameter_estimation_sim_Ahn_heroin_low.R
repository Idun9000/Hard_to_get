...
ctr_data <- read.csv('/work/DC_exam/Hard_to_get/out/LLM_simulated_data/deckn_results_ahn-addict-low_100_42_2024-12-21_13-38-50.txt', header = TRUE)
...
write.csv(samples_df, "posterior_samples_sim_Ahn_heroin_low.csv", row.names = FALSE)
...
png("traceplot_sim_Ahn_heroin_low.png", width = 1200, height = 800)
...
# Save the workspace 
save.image(file = "estimation_sim_Ahn_heroin_low.RData")