...
write.csv(samples_df, "posterior_samples_healthy_scale1000_Ahn.csv", row.names = FALSE)
...
png("traceplot_Ahn_healthy_scale1000.png", width = 1200, height = 800)
...
# Save the workspace 
save.image(file = "estimation_ahn_healthy_scale1000.RData")