...
ctr_data <- read.csv('/work/DC_exam/Hard_to_get/out/LLM_simulated_data/deckn_results_wetzels-control-high_150_42_2024-12-20_20-53-01.txt', header = TRUE)
...
png("traceplot_sim_Wetzel_healthy_high.png", width = 1200, height = 800)
...
# Save the workspace 
save.image(file = "estimation_sim_Wetzel_healthy_high.RData")