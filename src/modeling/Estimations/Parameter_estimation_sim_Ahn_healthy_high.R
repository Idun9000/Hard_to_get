...
ctr_data <- read.csv('/work/DC_exam/Hard_to_get/out/LLM_simulated_data/deckn_results_ahn-control-high_100_42_2024-12-20_13-30-59.txt', header = TRUE)
...
write.csv(samples_df, "posterior_samples_sim_Ahn_healthy_high.csv", row.names = FALSE)
...
png("traceplot_sim_Ahn_healthy_high.png", width = 1200, height = 800)
...
# Save the workspace 
save.image(file = "estimation_sim_Ahn_healthy_high.RData")