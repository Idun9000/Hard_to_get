...
write.csv(samples_df, "posterior_samples_heroin_Ahn.csv", row.names = FALSE)
...
png("traceplot_Ahn_heroin.png", width = 1200, height = 800)
...
# Save the workspace 
save.image(file = "estimation_ahn_heroin.RData")